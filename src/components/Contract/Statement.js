...
export default function Statement({
  ...
  const showRevTable = () => {
    if (formData && formData.sales_threshold) {
      ...
      threshold each month through the Amazon Seller Central and Vendor Central account(s) that BBE manages for Client.</td><td><span style=" background:#ffe5df;padding: 4px 9px;"> REVENUE_SHARE</span>  </td><td>REV_THRESHOLD</td></tr></table> </div>`;
    }
    ...
    through the Amazon Seller Central and Vendor Central account(s) that BBE manages for Client. </td><td><span style=" background:#ffe5df;padding: 4px 9px;"> REVENUE_SHARE </span> </td></tr></table></div>`;
  };
